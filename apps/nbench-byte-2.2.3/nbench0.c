...
//printf("[nbench] %s %d, addr of global_min_ticks: 0x%lx\n", __func__, __LINE__, \
	   (unsigned long)&global_min_ticks);
/*
...
for(i=0;i<NUMTESTS;i++)
{
		...
		//printf("[nbench] %s %d, addr of buffer 0x%lx\n", __func__, __LINE__, (unsigned long)buffer);
...
/*
printf("[##############] %s, %d\n", __func__, __LINE__);
printf("[####debug####] addr of mean is 0x%lx\n", (unsigned long)mean);
printf("[####debug####] value of mean is 0x%lx\n", *(unsigned long*)mean);
printf("[####debug####] addr of c_half_interval is 0x%lx\n", (unsigned long)&c_half_interval);
*/
//printf("[####debug####] c_half_interval %f, addr of mean is 0x%lx\n", c_half_interval, (unsigned long)mean);
        /*
...
//printf("[####debug####] value of mean is 0x%lx\n", *(unsigned long*)mean);
//printf("[###########] %s, %d\n", __func__, __LINE__);
//printf("[####debug####] c_half_interval %ld, mean %ld, addr of mean is 0x%lx\n", c_half_interval, *mean, (unsigned long)mean);
